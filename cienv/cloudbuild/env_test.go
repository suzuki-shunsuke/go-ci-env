...
func TestClient_RepoOwner(t *testing.T) {
	...
	data := []struct {
	...
	}{
		{
			...
			m: map[string]string{
				"cloudbuild":     "true",
				"_HEAD_REPO_URL": "https://github.com/suzuki-shunsuke/go-ci-env",
			},
			exp: "suzuki-shunsuke",
		},
	}
...
func TestClient_SHA(t *testing.T) {
	...
	data := []struct {
	...
	}{
		{
			...
			m: map[string]string{
				"cloudbuild": "true",
				"COMMIT_SHA": "c0c29ca335f2987583c9ecf077e4b476ca78b660",
			},
...
func TestClient_IsPR(t *testing.T) {
	...
	data := []struct {
	...
	}{
		{
			...
			m: map[string]string{
				"cloudbuild":     "true",
				"_HEAD_REPO_URL": "https://github.com/suzuki-shunsuke/go-ci-env/pull/1",
			},
			exp: true,
		},
		{
